...
Trabalhos prévios na literatura científica incluem o estudo de Dalla Palma et al. (2020), que desenvolveu um catálogo abrangente de 46 métricas de qualidade para código IaC baseado em Ansible, abrangendo atributos como linhas de código, presença de strings hard-coded e code smells associados a defeitos. Os autores validaram o catálogo por meio de modelos preditivos, alcançando precisão de 0,70 a 0,78 e recall de 0,54 a 0,67, demonstrando a viabilidade de adaptar métricas tradicionais de engenharia de software ao contexto de IaC. Adicionalmente, Rahman et al. (2024) investigaram a avaliação de qualidade em código gerado e aprimorado por IA, propondo um framework com métricas funcionais e não funcionais para artefatos de software, incluindo análise estática de vulnerabilidades e conformidade em cenários de automação. A aplicação em datasets reais de código gerado por LLMs revelou taxas de detecção de valores hard-coded de 25-35%, enfatizando a necessidade de validação empírica específica para geração assistida por IA em ambientes de desenvolvimento ágil.

### 2.4 Referencial teórico e empírico essencial
O referencial teórico deste experimento fundamenta-se em estudos que investigam segurança, defeitos e confiabilidade em Infrastructure as Code (IaC). Em particular, o mapeamento sistemático de Rahman et al. (2018) “A Systematic Mapping Study of Infrastructure as Code Research” oferece uma visão geral dos temas já explorados em IaC e evidencia lacunas relacionadas à investigação de defeitos e falhas de segurança em scripts de infraestrutura. Esse trabalho justifica a relevância de estudos que caracterizam problemas de qualidade em IaC, enquanto taxonomias de defeitos e vulnerabilidades vêm de estudos empíricos específicos sobre smells, padrões inseguros e problemas de configuração em scripts IaC.

Complementando essa base conceitual, no âmbito empírico, o framework proposto por Konala et al. (2025), no artigo “A Framework for Measuring the Quality of Infrastructure-as-Code Scripts”, operacionaliza a noção de qualidade em IaC ao definir nove categorias analíticas (por exemplo, estrutura de código, segurança e automação) alinhadas ao padrão ISO/IEC 25010 e validadas em repositórios Ansible. Os autores identificam mais de 100 atributos relevantes, como uso de valores hard‑coded e mecanismos de tratamento de erros, oferecendo um conjunto de indicadores práticos que dialoga diretamente com as lacunas apontadas por Rahman et al. e evidenciando a necessidade de avaliações padronizadas para mitigar riscos em scripts de provisionamento.

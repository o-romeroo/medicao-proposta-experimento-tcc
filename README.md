...
Estudos como o framework de qualidade de IaC de Sellam et al. (2019), que propõe dimensões como segurança e manutenibilidade; relatório da AWS sobre melhores práticas de Terraform (2025), destacando conformidade em multi-cloud; e análises recentes sobre IA em code generation (ex: Runloop, 2025), que identificam gaps em avaliação de IaC gerado por LLMs, com taxas de vulnerabilidades de 20-40% em códigos não revisados. Trabalhos em repositórios como GitHub (tflint-ruleset-aws, 2020-) fornecem baselines para métricas. Nenhum experimento idêntico foi encontrado, mas tendências em InfoQ (2025) indicam urgência para experimentos empíricos em DevSecOps com IA.

### 2.4 Referencial teórico e empírico essencial
O referencial teórico baseia-se no paradigma GQM (Goal-Question-Metric) de Basili et al. (1994), que estrutura experimentos científicos em software engineering para alinhar objetivos a métricas mensuráveis, promovendo objetividade e rastreabilidade – alinhado às boas práticas de escrita científica que enfatizam decomposição hierárquica e evidência empírica. Teoricamente, fundamenta-se em princípios de IaC (HashiCorp, 2025), como idempotência, versionamento e segurança declarativa, e no OWASP IaC Top 10 para vulnerabilidades. Empiricamente, inspira-se em estudos como o de Spacelift (2025) sobre validação de Terraform, mostrando que 70% dos códigos IaC falham em conformidade sem linting, e evidências de IA em DevOps (ex: Augment Code, 2025), onde LLMs como GPT reduzem tempo de codificação em 40%, mas introduzem 15-25% mais hard-coded values. Hipóteses derivam de tendências em SRE (Site Reliability Engineering), onde métricas como taxa de falhas em provisionamento correlacionam com qualidade de IaC, suportadas por dados do AWS Well-Architected Framework.
